...
let sct = true
// Credit system toggle removed, defaulting to SCT
...
$(function () {
    ...
    if (prioridad) {
        ...
        document.getElementById("custom-credits-standard").addEventListener("input", function updateSCTPlaceholder() {
            if (this.value == "")
...
// changeCreditsSystem function removed as SCT is now mandatory
